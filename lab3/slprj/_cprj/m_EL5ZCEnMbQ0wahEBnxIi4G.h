#ifndef __EL5ZCEnMbQ0wahEBnxIi4G_h__
#define __EL5ZCEnMbQ0wahEBnxIi4G_h__
...
#ifndef struct_tag_ibrqgxaZOSyQFWwv2BVLkG
#define struct_tag_ibrqgxaZOSyQFWwv2BVLkG

struct tag_ibrqgxaZOSyQFWwv2BVLkG
{
  char_T f1[4];
  char_T f2[6];
  char_T f3[7];
...
#endif                                 /* struct_tag_ibrqgxaZOSyQFWwv2BVLkG */

#ifndef typedef_cell
#define typedef_cell

typedef struct tag_ibrqgxaZOSyQFWwv2BVLkG cell;
...
typedef struct tag_zzpikWg63aMVfyyfTFqC9F b_cell;

#endif                                 /* typedef_b_cell */

#ifndef struct_tag_jnaTIMKBdxQXcUvt5MykCH
#define struct_tag_jnaTIMKBdxQXcUvt5MykCH

struct tag_jnaTIMKBdxQXcUvt5MykCH
{
  char_T f1[4];
  char_T f2[6];
  char_T f3[8];
...
#endif                                 /* struct_tag_jnaTIMKBdxQXcUvt5MykCH */

#ifndef typedef_c_cell
#define typedef_c_cell

typedef struct tag_jnaTIMKBdxQXcUvt5MykCH c_cell;
...
#ifndef struct_tag_jp4fGAy6NFnrolVyCLuLNB
#define struct_tag_jp4fGAy6NFnrolVyCLuLNB

struct tag_jp4fGAy6NFnrolVyCLuLNB
{
  char_T f1[2];
  char_T f2[6];
  char_T f3[6];
...
#endif                                 /* struct_tag_jp4fGAy6NFnrolVyCLuLNB */

#ifndef typedef_g_cell
#define typedef_g_cell

typedef struct tag_jp4fGAy6NFnrolVyCLuLNB g_cell;
...
#ifndef struct_tag_be49sswY9UhcmD3dyYQJ9F
#define struct_tag_be49sswY9UhcmD3dyYQJ9F

struct tag_be49sswY9UhcmD3dyYQJ9F
{
  cell _data;
};

#endif                                 /* struct_tag_be49sswY9UhcmD3dyYQJ9F */

#ifndef typedef_s_be49sswY9UhcmD3dyYQJ9F
#define typedef_s_be49sswY9UhcmD3dyYQJ9F

typedef struct tag_be49sswY9UhcmD3dyYQJ9F s_be49sswY9UhcmD3dyYQJ9F;

#endif                                 /* typedef_s_be49sswY9UhcmD3dyYQJ9F */
...
#ifndef struct_tag_LMjJFnNvXwEaFcF21wW61D
#define struct_tag_LMjJFnNvXwEaFcF21wW61D

struct tag_LMjJFnNvXwEaFcF21wW61D
{
  c_cell _data;
};

#endif                                 /* struct_tag_LMjJFnNvXwEaFcF21wW61D */

#ifndef typedef_s_LMjJFnNvXwEaFcF21wW61D
#define typedef_s_LMjJFnNvXwEaFcF21wW61D

typedef struct tag_LMjJFnNvXwEaFcF21wW61D s_LMjJFnNvXwEaFcF21wW61D;

#endif                                 /* typedef_s_LMjJFnNvXwEaFcF21wW61D */
...
#ifndef struct_tag_qwDlcA2sHdPiyKfeZA8zg
#define struct_tag_qwDlcA2sHdPiyKfeZA8zg

struct tag_qwDlcA2sHdPiyKfeZA8zg
{
  g_cell _data;
};

#endif                                 /* struct_tag_qwDlcA2sHdPiyKfeZA8zg */

#ifndef typedef_s_qwDlcA2sHdPiyKfeZA8zg
#define typedef_s_qwDlcA2sHdPiyKfeZA8zg

typedef struct tag_qwDlcA2sHdPiyKfeZA8zg s_qwDlcA2sHdPiyKfeZA8zg;

#endif                                 /* typedef_s_qwDlcA2sHdPiyKfeZA8zg */
...
#ifndef struct_tag_n0CrSWHWsyh9zAquGQXjYD
#define struct_tag_n0CrSWHWsyh9zAquGQXjYD

struct tag_n0CrSWHWsyh9zAquGQXjYD
{
  ...
  real_T pNCOCounter;
  creal_T pSymbolHolder[6175];
  real_T pLoopFilterState;
  real_T pLoopPreviousInput;
};

#endif                                 /* struct_tag_n0CrSWHWsyh9zAquGQXjYD */

#ifndef typedef_comm_SymbolSynchronizer
#define typedef_comm_SymbolSynchronizer

typedef struct tag_n0CrSWHWsyh9zAquGQXjYD comm_SymbolSynchronizer;

#endif                                 /* typedef_comm_SymbolSynchronizer */

#ifndef typedef_InstanceStruct_EL5ZCEnMbQ0wahEBnxIi4G
#define typedef_InstanceStruct_EL5ZCEnMbQ0wahEBnxIi4G

typedef struct {
  SimStruct *S;
  comm_SymbolSynchronizer sysobj;
...
#endif                                 /* typedef_InstanceStruct_EL5ZCEnMbQ0wahEBnxIi4G */
...
extern void method_dispatcher_EL5ZCEnMbQ0wahEBnxIi4G(SimStruct *S, int_T method,
  void* data);
