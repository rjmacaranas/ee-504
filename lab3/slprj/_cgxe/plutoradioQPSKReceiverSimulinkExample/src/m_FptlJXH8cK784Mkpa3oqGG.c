...
static emlrtRSInfo emlrtRSI = { 209,   /* lineNo */
  "CarrierSynchronizer",               /* fcnName */
  "/Applications/MATLAB_R2021b.app/toolbox/comm/comm/+comm/CarrierSynchronizer.m"/* pathName */
};
...
static emlrtRSInfo l_emlrtRSI = { 237, /* lineNo */
  "CarrierSynchronizer",               /* fcnName */
  "/Applications/MATLAB_R2021b.app/toolbox/comm/comm/+comm/CarrierSynchronizer.m"/* pathName */
};
...
static emlrtRSInfo o_emlrtRSI = { 223, /* lineNo */
  "CarrierSynchronizer",               /* fcnName */
  "/Applications/MATLAB_R2021b.app/toolbox/comm/comm/+comm/CarrierSynchronizer.m"/* pathName */
};
...
static emlrtRSInfo v_emlrtRSI = { 497, /* lineNo */
  "CarrierSynchronizer",               /* fcnName */
  "/Applications/MATLAB_R2021b.app/toolbox/comm/comm/+comm/CarrierSynchronizer.m"/* pathName */
};
...
static emlrtMCInfo c_emlrtMCI = { 14,  /* lineNo */
  ...
  "/Applications/MATLAB_R2021b.app/toolbox/eml/eml/+coder/+internal/+valattr/validatenonnan.m"/* pName */
};

static emlrtMCInfo d_emlrtMCI = { 13,  /* lineNo */
  37,                                  /* colNo */
  "validateinteger",                   /* fName */
  "/Applications/MATLAB_R2021b.app/toolbox/eml/eml/+coder/+internal/+valattr/validateinteger.m"/* pName */
};

static emlrtMCInfo e_emlrtMCI = { 22,  /* lineNo */
  27,                                  /* colNo */
  "validategt",                        /* fName */
  "/Applications/MATLAB_R2021b.app/toolbox/eml/eml/+coder/+internal/+valattr/validategt.m"/* pName */
};

static emlrtMCInfo f_emlrtMCI = { 22,  /* lineNo */
  27,                                  /* colNo */
  "validatele",                        /* fName */
  "/Applications/MATLAB_R2021b.app/toolbox/eml/eml/+coder/+internal/+valattr/validatele.m"/* pName */
};
...
static emlrtBCInfo emlrtBCI = { -1,    /* iFirst */
  ...
  "/Applications/MATLAB_R2021b.app/toolbox/comm/comm/+comm/CarrierSynchronizer.m",/* pName */
  0                                    /* checkKind */
};
...
static emlrtRSInfo w_emlrtRSI = { 3,   /* lineNo */
  "",                                  /* fcnName */
  ""                                   /* pathName */
};
...
static emlrtRSInfo x_emlrtRSI = { 14,  /* lineNo */
  ...
  "/Applications/MATLAB_R2021b.app/toolbox/eml/eml/+coder/+internal/+valattr/validatenonnan.m"/* pathName */
};
...
static emlrtRSInfo bb_emlrtRSI = { 13, /* lineNo */
  ...
  "/Applications/MATLAB_R2021b.app/toolbox/eml/eml/+coder/+internal/+valattr/validateinteger.m"/* pathName */
};

static emlrtRSInfo cb_emlrtRSI = { 22, /* lineNo */
  "validatele",                        /* fcnName */
  "/Applications/MATLAB_R2021b.app/toolbox/eml/eml/+coder/+internal/+valattr/validatele.m"/* pathName */
};

static emlrtRSInfo db_emlrtRSI = { 22, /* lineNo */
  "validategt",                        /* fcnName */
  "/Applications/MATLAB_R2021b.app/toolbox/eml/eml/+coder/+internal/+valattr/validategt.m"/* pathName */
};

/* Function Declarations */
static void cgxe_mdl_start(InstanceStruct_FptlJXH8cK784Mkpa3oqGG *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_FptlJXH8cK784Mkpa3oqGG
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_FptlJXH8cK784Mkpa3oqGG
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_FptlJXH8cK784Mkpa3oqGG
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_FptlJXH8cK784Mkpa3oqGG
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_FptlJXH8cK784Mkpa3oqGG
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_FptlJXH8cK784Mkpa3oqGG
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_FptlJXH8cK784Mkpa3oqGG
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj);
static void mw__internal__call__reset(InstanceStruct_FptlJXH8cK784Mkpa3oqGG
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth);
static void mw__internal__call__step(InstanceStruct_FptlJXH8cK784Mkpa3oqGG
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth, emxArray_creal_T *u0,
  emxArray_creal_T *b_y0);
static void mw__internal__system___fcn(InstanceStruct_FptlJXH8cK784Mkpa3oqGG
...
static void CarrierSynchronizer_stepImpl(const emlrtStack *sp,
  ...
  *output);
static const mxArray *emlrt_marshallOut(InstanceStruct_FptlJXH8cK784Mkpa3oqGG
  *moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_FptlJXH8cK784Mkpa3oqGG *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_FptlJXH8cK784Mkpa3oqGG
...
static void cgxe_mdl_set_sim_state(InstanceStruct_FptlJXH8cK784Mkpa3oqGG
...
static void emxEnsureCapacity_creal_T1(emxArray_creal_T *emxArray, int32_T
  oldNumel);
static void init_simulink_io_address(InstanceStruct_FptlJXH8cK784Mkpa3oqGG
  *moduleInstance);
  ...
  DampingFactor, real_T NormalizedLoopBandwidth, emxArray_creal_T *u0)
{
  ...
  if (!moduleInstance->sysobj_not_empty) {
    ...
    for (u0_idx_0 = 0; u0_idx_0 < 4; u0_idx_0++) {
      moduleInstance->sysobj.ModulationPhaseOffset[u0_idx_0] =
        correctedValue[u0_idx_0];
    }
  ...
  *output)
{
  ...
  for (k = 0; k <= i; k++) {
    phErr = muDoubleScalarSign(previousSample.re) * previousSample.im -
      muDoubleScalarSign(previousSample.im) * previousSample.re;
    b = obj->pPhase;
    ...
    i1 = input->size[0];
    b = input->data[emlrtDynamicBoundsCheckR2012b(k + 1, 1, loop_ub, &d_emlrtBCI,
      (void *)sp) - 1].re * previousSample.re - input->
      data[emlrtDynamicBoundsCheckR2012b(k + 1, 1, i1, &d_emlrtBCI, (void *)sp)
      - 1].im * previousSample.im;
    loop_ub = input->size[0];
    i1 = input->size[0];
    im = input->data[emlrtDynamicBoundsCheckR2012b(k + 1, 1, loop_ub,
      &d_emlrtBCI, (void *)sp) - 1].re * previousSample.im + input->
      data[emlrtDynamicBoundsCheckR2012b(k + 1, 1, i1, &d_emlrtBCI, (void *)sp)
      - 1].im * previousSample.re;
    loop_ub = output->size[0];
    output->data[emlrtDynamicBoundsCheckR2012b(k + 1, 1, loop_ub, &emlrtBCI,
      (void *)sp) - 1].re = b;
    loop_ub = output->size[0];
    output->data[emlrtDynamicBoundsCheckR2012b(k + 1, 1, loop_ub, &emlrtBCI,
      (void *)sp) - 1].im = im;
    ...
    phaseCorrection->data[emlrtDynamicBoundsCheckR2012b(k + 1, 1, loop_ub,
      &b_emlrtBCI, (void *)sp) - 1].re = obj->pPhase;
    loop_ub = phaseCorrection->size[0];
    phaseCorrection->data[emlrtDynamicBoundsCheckR2012b(k + 1, 1, loop_ub,
      &b_emlrtBCI, (void *)sp) - 1].im = 0.0;
    loop_ub = output->size[0];
    previousSample.re = output->data[emlrtDynamicBoundsCheckR2012b(k + 1, 1,
      loop_ub, &c_emlrtBCI, (void *)sp) - 1].re;
    loop_ub = output->size[0];
    previousSample.im = output->data[emlrtDynamicBoundsCheckR2012b(k + 1, 1,
      loop_ub, &c_emlrtBCI, (void *)sp) - 1].im;
  }
  ...
  *moduleInstance, const emlrtStack *sp)
{
  ...
  *(int32_T *)emlrtMxGetData(m) = u;
  emlrtAssign(&d_y, m);
  emlrtSetFieldR2017b(c_y, 0, (const char_T *)"isInitialized", d_y, 0);
  b_u = moduleInstance->sysobj.TunablePropsChanged;
  e_y = NULL;
  m = emlrtCreateLogicalScalar(b_u);
  emlrtAssign(&e_y, m);
  emlrtSetFieldR2017b(c_y, 0, (const char_T *)"TunablePropsChanged", e_y, 1);
  ...
  emlrtAssign(&g_y, m);
  emlrtSetFieldR2017b(f_y, 0, (const char_T *)"f1", g_y, 0);
  emlrtSetFieldR2017b(c_y, 0, (const char_T *)"inputVarSize", f_y, 2);
  b_u = moduleInstance->sysobj.CacheInputSizes;
  h_y = NULL;
  m = emlrtCreateLogicalScalar(b_u);
  emlrtAssign(&h_y, m);
  emlrtSetFieldR2017b(c_y, 0, (const char_T *)"CacheInputSizes", h_y, 3);
  for (u = 0; u < 4; u++) {
  ...
  i_y = NULL;
  m = emlrtCreateCharArray(2, &iv3[0]);
  emlrtInitCharArrayR2013a((void *)sp, 4, m, &e_u[0]);
  emlrtAssign(&i_y, m);
  emlrtSetFieldR2017b(c_y, 0, (const char_T *)"ModulationPhaseOffset", i_y, 4);
  f_u = moduleInstance->sysobj.CustomPhaseOffset;
  j_y = NULL;
  m = emlrtCreateDoubleScalar(f_u);
  emlrtAssign(&j_y, m);
  emlrtSetFieldR2017b(c_y, 0, (const char_T *)"CustomPhaseOffset", j_y, 5);
  f_u = moduleInstance->sysobj.SamplesPerSymbol;
  k_y = NULL;
  m = emlrtCreateDoubleScalar(f_u);
  emlrtAssign(&k_y, m);
  emlrtSetFieldR2017b(c_y, 0, (const char_T *)"SamplesPerSymbol", k_y, 6);
  f_u = moduleInstance->sysobj.DampingFactor;
  l_y = NULL;
  m = emlrtCreateDoubleScalar(f_u);
  emlrtAssign(&l_y, m);
  emlrtSetFieldR2017b(c_y, 0, (const char_T *)"DampingFactor", l_y, 7);
  f_u = moduleInstance->sysobj.NormalizedLoopBandwidth;
  m_y = NULL;
  m = emlrtCreateDoubleScalar(f_u);
  emlrtAssign(&m_y, m);
  emlrtSetFieldR2017b(c_y, 0, (const char_T *)"NormalizedLoopBandwidth", m_y, 8);
  f_u = moduleInstance->sysobj.pProportionalGain;
  n_y = NULL;
  m = emlrtCreateDoubleScalar(f_u);
  emlrtAssign(&n_y, m);
  emlrtSetFieldR2017b(c_y, 0, (const char_T *)"pProportionalGain", n_y, 9);
  f_u = moduleInstance->sysobj.pIntegratorGain;
  o_y = NULL;
  m = emlrtCreateDoubleScalar(f_u);
  emlrtAssign(&o_y, m);
  emlrtSetFieldR2017b(c_y, 0, (const char_T *)"pIntegratorGain", o_y, 10);
  f_u = moduleInstance->sysobj.pDigitalSynthesizerGain;
  p_y = NULL;
  m = emlrtCreateDoubleScalar(f_u);
  emlrtAssign(&p_y, m);
  emlrtSetFieldR2017b(c_y, 0, (const char_T *)"pDigitalSynthesizerGain", p_y, 11);
  f_u = moduleInstance->sysobj.pPhase;
  q_y = NULL;
  m = emlrtCreateDoubleScalar(f_u);
  emlrtAssign(&q_y, m);
  emlrtSetFieldR2017b(c_y, 0, (const char_T *)"pPhase", q_y, 12);
  ...
  emlrtAssign(&r_y, m);
  emlrtSetFieldR2017b(c_y, 0, (const char_T *)"pPreviousSample", r_y, 13);
  f_u = moduleInstance->sysobj.pActualPhaseOffset;
  s_y = NULL;
  m = emlrtCreateDoubleScalar(f_u);
  emlrtAssign(&s_y, m);
  emlrtSetFieldR2017b(c_y, 0, (const char_T *)"pActualPhaseOffset", s_y, 14);
  f_u = moduleInstance->sysobj.pLoopFilterState;
  t_y = NULL;
  m = emlrtCreateDoubleScalar(f_u);
  emlrtAssign(&t_y, m);
  emlrtSetFieldR2017b(c_y, 0, (const char_T *)"pLoopFilterState", t_y, 15);
  f_u = moduleInstance->sysobj.pIntegFilterState;
  u_y = NULL;
  m = emlrtCreateDoubleScalar(f_u);
  emlrtAssign(&u_y, m);
  emlrtSetFieldR2017b(c_y, 0, (const char_T *)"pIntegFilterState", u_y, 16);
  f_u = moduleInstance->sysobj.pDDSPreviousInput;
  v_y = NULL;
  m = emlrtCreateDoubleScalar(f_u);
  emlrtAssign(&v_y, m);
  emlrtSetFieldR2017b(c_y, 0, (const char_T *)"pDDSPreviousInput", v_y, 17);
  ...
  emlrtMsgIdentifier *parentId, comm_CarrierSynchronizer *y)
{
  ...
  thisId.bParentIsCell = false;
  emlrtCheckStructR2012b((void *)sp, parentId, u, 18, (const char_T **)
    &fieldNames[0], 0U, (void *)&dims);
  thisId.fIdentifier = "isInitialized";
  y->isInitialized = f_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b((void
  ...
  h_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b((void *)sp, u, 0, 2, (
  ...
  y->CacheInputSizes = g_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b
    ((void *)sp, u, 0, 3, (const char_T *)"CacheInputSizes")), &thisId);
  thisId.fIdentifier = "ModulationPhaseOffset";
  j_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b((void *)sp, u, 0, 4, (
    const char_T *)"ModulationPhaseOffset")), &thisId, y->ModulationPhaseOffset);
  thisId.fIdentifier = "CustomPhaseOffset";
  y->CustomPhaseOffset = k_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b
    ((void *)sp, u, 0, 5, (const char_T *)"CustomPhaseOffset")), &thisId);
  thisId.fIdentifier = "SamplesPerSymbol";
  y->SamplesPerSymbol = k_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b
    ((void *)sp, u, 0, 6, (const char_T *)"SamplesPerSymbol")), &thisId);
  thisId.fIdentifier = "DampingFactor";
  y->DampingFactor = k_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b((void
    *)sp, u, 0, 7, (const char_T *)"DampingFactor")), &thisId);
  thisId.fIdentifier = "NormalizedLoopBandwidth";
  y->NormalizedLoopBandwidth = k_emlrt_marshallIn(sp, emlrtAlias
    (emlrtGetFieldR2017b((void *)sp, u, 0, 8, (const char_T *)
  ...
  emlrtMsgIdentifier *parentId, cell_wrap y[1])
{
  ...
  i_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b((void *)sp, u, 0, 0, (
  ...
  emlrtMsgIdentifier *msgId, char_T ret[4])
{
  ...
  emlrtCheckBuiltInR2012b((void *)sp, msgId, src, (const char_T *)"char", false,
    2U, (void *)&dims[0]);
  emlrtImportCharArrayR2015b((void *)sp, src, &ret[0], 4);
  emlrtDestroyArray(&src);
}
  ...
  const emlrtMsgIdentifier *msgId)
{
  ...
  emlrtCheckBuiltInR2012b((void *)sp, msgId, src, (const char_T *)"double", true,
    0U, (void *)&dims);
  emlrtImportArrayR2015b((void *)sp, src, &ret, 8, true);
  emlrtDestroyArray(&src);
  return ret;
}
...
/* CGXE Glue Code */
static void mdlOutputs_FptlJXH8cK784Mkpa3oqGG(SimStruct *S, int_T tid)
{
  InstanceStruct_FptlJXH8cK784Mkpa3oqGG *moduleInstance =
    (InstanceStruct_FptlJXH8cK784Mkpa3oqGG *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_FptlJXH8cK784Mkpa3oqGG(SimStruct *S)
{
  InstanceStruct_FptlJXH8cK784Mkpa3oqGG *moduleInstance =
    (InstanceStruct_FptlJXH8cK784Mkpa3oqGG *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_FptlJXH8cK784Mkpa3oqGG(SimStruct *S, int_T tid)
{
  InstanceStruct_FptlJXH8cK784Mkpa3oqGG *moduleInstance =
    (InstanceStruct_FptlJXH8cK784Mkpa3oqGG *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_FptlJXH8cK784Mkpa3oqGG(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_FptlJXH8cK784Mkpa3oqGG *moduleInstance =
    (InstanceStruct_FptlJXH8cK784Mkpa3oqGG *)cgxertGetRuntimeInstance(S);
...
static void setSimState_FptlJXH8cK784Mkpa3oqGG(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_FptlJXH8cK784Mkpa3oqGG *moduleInstance =
    (InstanceStruct_FptlJXH8cK784Mkpa3oqGG *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_FptlJXH8cK784Mkpa3oqGG(SimStruct *S)
{
  InstanceStruct_FptlJXH8cK784Mkpa3oqGG *moduleInstance =
    (InstanceStruct_FptlJXH8cK784Mkpa3oqGG *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_FptlJXH8cK784Mkpa3oqGG(SimStruct *S)
{
  InstanceStruct_FptlJXH8cK784Mkpa3oqGG *moduleInstance =
    (InstanceStruct_FptlJXH8cK784Mkpa3oqGG *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_FptlJXH8cK784Mkpa3oqGG(SimStruct *S)
{
  InstanceStruct_FptlJXH8cK784Mkpa3oqGG *moduleInstance =
    (InstanceStruct_FptlJXH8cK784Mkpa3oqGG *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_FptlJXH8cK784Mkpa3oqGG(SimStruct *S)
{
  InstanceStruct_FptlJXH8cK784Mkpa3oqGG *moduleInstance =
    (InstanceStruct_FptlJXH8cK784Mkpa3oqGG *)calloc(1, sizeof
    (InstanceStruct_FptlJXH8cK784Mkpa3oqGG));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_FptlJXH8cK784Mkpa3oqGG);
  ssSetmdlInitializeConditions(S, mdlInitialize_FptlJXH8cK784Mkpa3oqGG);
  ssSetmdlUpdate(S, mdlUpdate_FptlJXH8cK784Mkpa3oqGG);
  ssSetmdlTerminate(S, mdlTerminate_FptlJXH8cK784Mkpa3oqGG);
  ssSetmdlEnable(S, mdlEnable_FptlJXH8cK784Mkpa3oqGG);
  ssSetmdlDisable(S, mdlDisable_FptlJXH8cK784Mkpa3oqGG);
...
static void mdlProcessParameters_FptlJXH8cK784Mkpa3oqGG(SimStruct *S)
{
}

void method_dispatcher_FptlJXH8cK784Mkpa3oqGG(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_FptlJXH8cK784Mkpa3oqGG(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_FptlJXH8cK784Mkpa3oqGG(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_FptlJXH8cK784Mkpa3oqGG(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_FptlJXH8cK784Mkpa3oqGG(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: FptlJXH8cK784Mkpa3oqGG.\n"
...
mxArray *cgxe_FptlJXH8cK784Mkpa3oqGG_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_FptlJXH8cK784Mkpa3oqGG_fallback_info(void)
{
