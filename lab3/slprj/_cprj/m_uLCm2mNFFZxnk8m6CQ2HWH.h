#ifndef __uLCm2mNFFZxnk8m6CQ2HWH_h__
#define __uLCm2mNFFZxnk8m6CQ2HWH_h__
...
/* Type Definitions */
#ifndef struct_tag_3aUbJLwoLYeGlOuAeLAVB
#define struct_tag_3aUbJLwoLYeGlOuAeLAVB

struct tag_3aUbJLwoLYeGlOuAeLAVB
{
  real_T f1;
  real_T f2;
  real_T f3;
...
#endif                                 /* struct_tag_3aUbJLwoLYeGlOuAeLAVB */

#ifndef typedef_s_3aUbJLwoLYeGlOuAeLAVB
#define typedef_s_3aUbJLwoLYeGlOuAeLAVB

typedef struct tag_3aUbJLwoLYeGlOuAeLAVB s_3aUbJLwoLYeGlOuAeLAVB;

#endif                                 /* typedef_s_3aUbJLwoLYeGlOuAeLAVB */

#ifndef struct_tag_sOOdQFSjKdczutLl8RRtl
#define struct_tag_sOOdQFSjKdczutLl8RRtl

struct tag_sOOdQFSjKdczutLl8RRtl
{
  s_3aUbJLwoLYeGlOuAeLAVB _data;
};

#endif                                 /* struct_tag_sOOdQFSjKdczutLl8RRtl */

#ifndef typedef_s_sOOdQFSjKdczutLl8RRtl
#define typedef_s_sOOdQFSjKdczutLl8RRtl

typedef struct tag_sOOdQFSjKdczutLl8RRtl s_sOOdQFSjKdczutLl8RRtl;

#endif                                 /* typedef_s_sOOdQFSjKdczutLl8RRtl */
...
#ifndef struct_tag_lCbqwZkcLZ47xZTZ5BTIaE
#define struct_tag_lCbqwZkcLZ47xZTZ5BTIaE

struct tag_lCbqwZkcLZ47xZTZ5BTIaE
{
  char_T f1[4];
  char_T f2[6];
  char_T f3[8];
...
#endif                                 /* struct_tag_lCbqwZkcLZ47xZTZ5BTIaE */

#ifndef typedef_cell
#define typedef_cell

typedef struct tag_lCbqwZkcLZ47xZTZ5BTIaE cell;
...
#ifndef struct_tag_I8n26qMAstvwiPVKlLDSMH
#define struct_tag_I8n26qMAstvwiPVKlLDSMH

struct tag_I8n26qMAstvwiPVKlLDSMH
{
  cell _data;
};

#endif                                 /* struct_tag_I8n26qMAstvwiPVKlLDSMH */

#ifndef typedef_s_I8n26qMAstvwiPVKlLDSMH
#define typedef_s_I8n26qMAstvwiPVKlLDSMH

typedef struct tag_I8n26qMAstvwiPVKlLDSMH s_I8n26qMAstvwiPVKlLDSMH;

#endif                                 /* typedef_s_I8n26qMAstvwiPVKlLDSMH */
...
#ifndef struct_tag_UPpNGAc2YSEpT9F01gmJvB
#define struct_tag_UPpNGAc2YSEpT9F01gmJvB

struct tag_UPpNGAc2YSEpT9F01gmJvB
{
  boolean_T matlabCodegenIsDeleted;
  int32_T isInitialized;
  boolean_T isSetupComplete;
  cell_wrap inputVarSize[3];
  boolean_T CacheInputSizes;
  real_T pPrbLenOffset;
  creal_T pBuffer[28065];
  real_T pNBuffer;
  real_T pBufferStartIdx;
  real_T pBufferEndIdx;
  real_T pPrbIdxBuffer[5];
  real_T pNPrbIdxBuffer;
  real_T pPrbIdxBufferStartIdx;
};

#endif                                 /* struct_tag_UPpNGAc2YSEpT9F01gmJvB */

#ifndef typedef_comm_internal_examples_FrameSynchronizer
#define typedef_comm_internal_examples_FrameSynchronizer

typedef struct tag_UPpNGAc2YSEpT9F01gmJvB
  comm_internal_examples_FrameSynchronizer;

#endif                                 /* typedef_comm_internal_examples_FrameSynchronizer */

#ifndef typedef_InstanceStruct_uLCm2mNFFZxnk8m6CQ2HWH
#define typedef_InstanceStruct_uLCm2mNFFZxnk8m6CQ2HWH

typedef struct {
  SimStruct *S;
  comm_internal_examples_FrameSynchronizer sysobj;
  boolean_T sysobj_not_empty;
  creal_T u[28065];
  real_T u_tmp1_data[6175];
  real_T u_tmp2_data[6175];
  real_T varargin_3_data[6175];
...
#endif                                 /* typedef_InstanceStruct_uLCm2mNFFZxnk8m6CQ2HWH */
...
extern void method_dispatcher_uLCm2mNFFZxnk8m6CQ2HWH(SimStruct *S, int_T method,
  void* data);
