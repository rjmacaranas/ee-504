...
static emlrtRSInfo emlrtRSI = { 147,   /* lineNo */
  ...
  "/Applications/MATLAB_R2021b.app/toolbox/comm/comm/+comm/PreambleDetector.m"/* pathName */
};
...
static emlrtRSInfo r_emlrtRSI = { 277, /* lineNo */
  "filter",                            /* fcnName */
  "/Applications/MATLAB_R2021b.app/toolbox/eml/lib/matlab/datafun/filter.m"/* pathName */
};
...
static emlrtRSInfo u_emlrtRSI = { 42,  /* lineNo */
  ...
  "/Applications/MATLAB_R2021b.app/toolbox/eml/eml/+coder/+internal/indexShapeCheck.m"/* pathName */
};
...
static emlrtMCInfo b_emlrtMCI = { 14,  /* lineNo */
  ...
  "/Applications/MATLAB_R2021b.app/toolbox/eml/eml/+coder/+internal/+valattr/validatenonnegative.m"/* pName */
};
...
static emlrtMCInfo d_emlrtMCI = { 458, /* lineNo */
  ...
  "/Applications/MATLAB_R2021b.app/toolbox/comm/comm/+comm/PreambleDetector.m"/* pName */
};

static emlrtMCInfo e_emlrtMCI = { 47,  /* lineNo */
  19,                                  /* colNo */
  "allOrAny",                          /* fName */
  "/Applications/MATLAB_R2021b.app/toolbox/eml/eml/+coder/+internal/allOrAny.m"/* pName */
};

static emlrtMCInfo f_emlrtMCI = { 34,  /* lineNo */
  19,                                  /* colNo */
  "filter",                            /* fName */
  "/Applications/MATLAB_R2021b.app/toolbox/eml/lib/matlab/datafun/filter.m"/* pName */
};
...
static emlrtMCInfo i_emlrtMCI = { 122, /* lineNo */
  ...
  "/Applications/MATLAB_R2021b.app/toolbox/eml/eml/+coder/+internal/indexShapeCheck.m"/* pName */
};
...
static emlrtRSInfo w_emlrtRSI = { 14,  /* lineNo */
  ...
  "/Applications/MATLAB_R2021b.app/toolbox/eml/eml/+coder/+internal/+valattr/validatenonnegative.m"/* pathName */
};
...
static emlrtRSInfo y_emlrtRSI = { 122, /* lineNo */
  "indexShapeCheck",                   /* fcnName */
  "/Applications/MATLAB_R2021b.app/toolbox/eml/eml/+coder/+internal/indexShapeCheck.m"/* pathName */
};
...
static void cgxe_mdl_start(InstanceStruct_RpNfljt9ezw1bujKbI0k9E *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_RpNfljt9ezw1bujKbI0k9E
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_RpNfljt9ezw1bujKbI0k9E
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_RpNfljt9ezw1bujKbI0k9E
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_RpNfljt9ezw1bujKbI0k9E
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_RpNfljt9ezw1bujKbI0k9E
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_RpNfljt9ezw1bujKbI0k9E
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_RpNfljt9ezw1bujKbI0k9E
...
static void mw__internal__call__reset(InstanceStruct_RpNfljt9ezw1bujKbI0k9E
  *moduleInstance, const emlrtStack *sp, real_T Threshold);
static void mw__internal__call__step(InstanceStruct_RpNfljt9ezw1bujKbI0k9E
  *moduleInstance, const emlrtStack *sp, real_T Threshold, emxArray_creal_T *u0,
  real_T b_y0_data[], int32_T y0_size[2], real_T b_y1_data[], int32_T y1_size[2]);
static void mw__internal__system___fcn(InstanceStruct_RpNfljt9ezw1bujKbI0k9E
...
static void indexShapeCheck(const emlrtStack *sp, int32_T matrixSize, int32_T
  indexSize[2]);
static const mxArray *emlrt_marshallOut(InstanceStruct_RpNfljt9ezw1bujKbI0k9E
  *moduleInstance, const emlrtStack *sp);
static const mxArray *b_emlrt_marshallOut(const int32_T u[2]);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_RpNfljt9ezw1bujKbI0k9E *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_RpNfljt9ezw1bujKbI0k9E
...
static void cgxe_mdl_set_sim_state(InstanceStruct_RpNfljt9ezw1bujKbI0k9E
...
static void emxEnsureCapacity_creal_T1(emxArray_creal_T *emxArray, int32_T
  oldNumel);
static void init_simulink_io_address(InstanceStruct_RpNfljt9ezw1bujKbI0k9E
  *moduleInstance);
  ...
  *moduleInstance, const emlrtStack *sp, real_T Threshold)
{
  ...
  if (moduleInstance->sysobj.isInitialized == 1) {
    b_st.site = &e_emlrtRSI;
    for (i = 0; i < 12; i++) {
      moduleInstance->sysobj.pFilterStates[i].re = 0.0;
      moduleInstance->sysobj.pFilterStates[i].im = 0.0;
    }
  }
  ...
  real_T b_y0_data[], int32_T y0_size[2], real_T b_y1_data[], int32_T y1_size[2])
{
  ...
  emlrtDimSizeGeqCheckR2012b(6175, b_y0_size[0], &emlrtECI, (void *)sp);
  ...
  emlrtDimSizeGeqCheckR2012b(6175, b_y1_size[0], &b_emlrtECI, (void *)sp);
  ...
  varargout_1_size[1], real_T varargout_2_data[], int32_T varargout_2_size[1])
{
  ...
  if (obj->isInitialized == 2) {
    ...
    y = NULL;
    m = emlrtCreateCharArray(2, &iv[0]);
    emlrtInitCharArrayR2013a((void *)sp, 45, m, &u[0]);
    emlrtAssign(&y, m);
    for (i = 0; i < 45; i++) {
      u[i] = b_u[i];
    }
    ...
    c_y = NULL;
    m = emlrtCreateCharArray(2, &iv2[0]);
    emlrtInitCharArrayR2013a((void *)sp, 4, m, &c_u[0]);
    emlrtAssign(&c_y, m);
    st.site = &e_emlrtRSI;
    error(&st, y, getString(&st, message(&st, b_y, c_y, &c_emlrtMCI),
           &c_emlrtMCI), &c_emlrtMCI);
  ...
  real_T crossCorr_data[], int32_T crossCorr_size[1], creal_T newFilterStates[12])
{
  ...
  if (!all(tmp_data, tmp_size)) {
    ...
    y = NULL;
    m = emlrtCreateCharArray(2, &iv[0]);
    emlrtInitCharArrayR2013a((void *)sp, 36, m, &b_u[0]);
    emlrtAssign(&y, m);
    for (i = 0; i < 36; i++) {
      b_u[i] = c_u[i];
    }
                     ...
                     int32_T i_data[], int32_T i_size[1])
{
  ...
  if (!(idx <= x_size[0])) {
    ...
    y = NULL;
    m = emlrtCreateCharArray(2, &iv1[0]);
    emlrtInitCharArrayR2013a((void *)sp, 30, m, &u[0]);
    emlrtAssign(&y, m);
    for (nx = 0; nx < 30; nx++) {
      u[nx] = b_u[nx];
    }
  ...
  *moduleInstance, const emlrtStack *sp)
{
  ...
  b_y = NULL;
  emlrtAssign(&b_y, emlrtCreateStructMatrix(1, 1, 7, (const char_T **)&sv[0]));
  ...
  *(int32_T *)emlrtMxGetData(m) = u;
  ...
  emlrtAssign(&f_y, m);
  emlrtSetFieldR2017b(e_y, 0, (const char_T *)"f1", f_y, 0);
  emlrtSetFieldR2017b(b_y, 0, (const char_T *)"inputVarSize", e_y, 2);
  g_y = NULL;
  m = emlrtCreateLogicalScalar(moduleInstance->sysobj.CacheInputSizes);
  emlrtAssign(&g_y, m);
  emlrtSetFieldR2017b(b_y, 0, (const char_T *)"CacheInputSizes", g_y, 3);
  h_y = NULL;
  m = emlrtCreateDoubleScalar(moduleInstance->sysobj.Threshold);
  emlrtAssign(&h_y, m);
  emlrtSetFieldR2017b(b_y, 0, (const char_T *)"Threshold", h_y, 4);
  i_y = NULL;
  m = emlrtCreateDoubleScalar(moduleInstance->sysobj.pThreshold);
  emlrtAssign(&i_y, m);
  emlrtSetFieldR2017b(b_y, 0, (const char_T *)"pThreshold", i_y, 5);
  memcpy(&d_u[0], &moduleInstance->sysobj.pFilterStates[0], 12U * sizeof(creal_T));
  j_y = NULL;
  m = emlrtCreateNumericArray(1, (const void *)&iv2[0], mxDOUBLE_CLASS,
    mxCOMPLEX);
  emlrtExportNumericArrayR2013b((void *)sp, m, &d_u[0], 8);
  emlrtAssign(&j_y, m);
  emlrtSetFieldR2017b(b_y, 0, (const char_T *)"pFilterStates", j_y, 6);
  ...
  *moduleInstance, const emlrtStack *sp, const mxArray *u)
{
  ...
  b_emlrt_marshallIn(sp, emlrtAlias(emlrtGetCell((void *)sp, &thisId, u, 0)),
                     "v", *moduleInstance->v);
  thisId.fIdentifier = "v";
  b_emlrt_marshallIn(sp, emlrtAlias(emlrtGetCell((void *)sp, &thisId, u, 1)),
                     "v", *moduleInstance->b_v);
  thisId.fIdentifier = "sysobj";
  d_emlrt_marshallIn(sp, emlrtAlias(emlrtGetCell((void *)sp, &thisId, u, 2)),
  ...
  moduleInstance->sysobj_not_empty = l_emlrt_marshallIn(sp, emlrtAlias
    (emlrtGetCell((void *)sp, &thisId, u, 3)), "sysobj_not_empty");
  emlrtDestroyArray(&u);
}
  ...
  emlrtMsgIdentifier *parentId, comm_PreambleDetector *y)
{
  ...
  thisId.bParentIsCell = false;
  emlrtCheckStructR2012b((void *)sp, parentId, u, 7, (const char_T **)
  ...
  y->Threshold = j_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b((void *)
    sp, u, 0, 4, (const char_T *)"Threshold")), &thisId);
  thisId.fIdentifier = "pThreshold";
  y->pThreshold = j_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b((void *)
    sp, u, 0, 5, (const char_T *)"pThreshold")), &thisId);
  thisId.fIdentifier = "pFilterStates";
  k_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b((void *)sp, u, 0, 6, (
    const char_T *)"pFilterStates")), &thisId, y->pFilterStates);
  emlrtDestroyArray(&u);
}
...
/* CGXE Glue Code */
static void mdlOutputs_RpNfljt9ezw1bujKbI0k9E(SimStruct *S, int_T tid)
{
  InstanceStruct_RpNfljt9ezw1bujKbI0k9E *moduleInstance =
    (InstanceStruct_RpNfljt9ezw1bujKbI0k9E *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_RpNfljt9ezw1bujKbI0k9E(SimStruct *S)
{
  InstanceStruct_RpNfljt9ezw1bujKbI0k9E *moduleInstance =
    (InstanceStruct_RpNfljt9ezw1bujKbI0k9E *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_RpNfljt9ezw1bujKbI0k9E(SimStruct *S, int_T tid)
{
  InstanceStruct_RpNfljt9ezw1bujKbI0k9E *moduleInstance =
    (InstanceStruct_RpNfljt9ezw1bujKbI0k9E *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_RpNfljt9ezw1bujKbI0k9E(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_RpNfljt9ezw1bujKbI0k9E *moduleInstance =
    (InstanceStruct_RpNfljt9ezw1bujKbI0k9E *)cgxertGetRuntimeInstance(S);
...
static void setSimState_RpNfljt9ezw1bujKbI0k9E(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_RpNfljt9ezw1bujKbI0k9E *moduleInstance =
    (InstanceStruct_RpNfljt9ezw1bujKbI0k9E *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_RpNfljt9ezw1bujKbI0k9E(SimStruct *S)
{
  InstanceStruct_RpNfljt9ezw1bujKbI0k9E *moduleInstance =
    (InstanceStruct_RpNfljt9ezw1bujKbI0k9E *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_RpNfljt9ezw1bujKbI0k9E(SimStruct *S)
{
  InstanceStruct_RpNfljt9ezw1bujKbI0k9E *moduleInstance =
    (InstanceStruct_RpNfljt9ezw1bujKbI0k9E *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_RpNfljt9ezw1bujKbI0k9E(SimStruct *S)
{
  InstanceStruct_RpNfljt9ezw1bujKbI0k9E *moduleInstance =
    (InstanceStruct_RpNfljt9ezw1bujKbI0k9E *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_RpNfljt9ezw1bujKbI0k9E(SimStruct *S)
{
  InstanceStruct_RpNfljt9ezw1bujKbI0k9E *moduleInstance =
    (InstanceStruct_RpNfljt9ezw1bujKbI0k9E *)calloc(1, sizeof
    (InstanceStruct_RpNfljt9ezw1bujKbI0k9E));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_RpNfljt9ezw1bujKbI0k9E);
  ssSetmdlInitializeConditions(S, mdlInitialize_RpNfljt9ezw1bujKbI0k9E);
  ssSetmdlUpdate(S, mdlUpdate_RpNfljt9ezw1bujKbI0k9E);
  ssSetmdlTerminate(S, mdlTerminate_RpNfljt9ezw1bujKbI0k9E);
  ssSetmdlEnable(S, mdlEnable_RpNfljt9ezw1bujKbI0k9E);
  ssSetmdlDisable(S, mdlDisable_RpNfljt9ezw1bujKbI0k9E);
...
static void mdlProcessParameters_RpNfljt9ezw1bujKbI0k9E(SimStruct *S)
{
}

void method_dispatcher_RpNfljt9ezw1bujKbI0k9E(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_RpNfljt9ezw1bujKbI0k9E(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_RpNfljt9ezw1bujKbI0k9E(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_RpNfljt9ezw1bujKbI0k9E(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_RpNfljt9ezw1bujKbI0k9E(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: RpNfljt9ezw1bujKbI0k9E.\n"
...
mxArray *cgxe_RpNfljt9ezw1bujKbI0k9E_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_RpNfljt9ezw1bujKbI0k9E_fallback_info(void)
{
