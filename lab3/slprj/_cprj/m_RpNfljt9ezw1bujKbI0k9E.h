#ifndef __RpNfljt9ezw1bujKbI0k9E_h__
#define __RpNfljt9ezw1bujKbI0k9E_h__
...
/* Type Definitions */
#ifndef struct_tag_LzZsD66XetcYUq3FtBW26G
#define struct_tag_LzZsD66XetcYUq3FtBW26G

struct tag_LzZsD66XetcYUq3FtBW26G
{
  real_T f1;
};

#endif                                 /* struct_tag_LzZsD66XetcYUq3FtBW26G */

#ifndef typedef_s_LzZsD66XetcYUq3FtBW26G
#define typedef_s_LzZsD66XetcYUq3FtBW26G

typedef struct tag_LzZsD66XetcYUq3FtBW26G s_LzZsD66XetcYUq3FtBW26G;

#endif                                 /* typedef_s_LzZsD66XetcYUq3FtBW26G */

#ifndef struct_tag_kFPEcEjQaLaJP75zhG6i6C
#define struct_tag_kFPEcEjQaLaJP75zhG6i6C

struct tag_kFPEcEjQaLaJP75zhG6i6C
{
  s_LzZsD66XetcYUq3FtBW26G _data;
};

#endif                                 /* struct_tag_kFPEcEjQaLaJP75zhG6i6C */

#ifndef typedef_s_kFPEcEjQaLaJP75zhG6i6C
#define typedef_s_kFPEcEjQaLaJP75zhG6i6C

typedef struct tag_kFPEcEjQaLaJP75zhG6i6C s_kFPEcEjQaLaJP75zhG6i6C;

#endif                                 /* typedef_s_kFPEcEjQaLaJP75zhG6i6C */
...
#ifndef struct_tag_6HUTMvSh3atWlnLsoj3lZC
#define struct_tag_6HUTMvSh3atWlnLsoj3lZC

struct tag_6HUTMvSh3atWlnLsoj3lZC
{
  char_T f1[6];
  char_T f2[6];
  char_T f3[5];
...
#endif                                 /* struct_tag_6HUTMvSh3atWlnLsoj3lZC */

#ifndef typedef_cell
#define typedef_cell

typedef struct tag_6HUTMvSh3atWlnLsoj3lZC cell;
...
typedef struct tag_gMx1TELpeUgCpv5HoUkWy b_cell;
...
#ifndef struct_tag_DsaMxo0Y7OPkCXaRLRhH7B
#define struct_tag_DsaMxo0Y7OPkCXaRLRhH7B

struct tag_DsaMxo0Y7OPkCXaRLRhH7B
{
  cell _data;
};

#endif                                 /* struct_tag_DsaMxo0Y7OPkCXaRLRhH7B */

#ifndef typedef_s_DsaMxo0Y7OPkCXaRLRhH7B
#define typedef_s_DsaMxo0Y7OPkCXaRLRhH7B

typedef struct tag_DsaMxo0Y7OPkCXaRLRhH7B s_DsaMxo0Y7OPkCXaRLRhH7B;

#endif                                 /* typedef_s_DsaMxo0Y7OPkCXaRLRhH7B */
...
#ifndef struct_tag_BPZvgbgNhgdvo9Q6vd49RH
#define struct_tag_BPZvgbgNhgdvo9Q6vd49RH

struct tag_BPZvgbgNhgdvo9Q6vd49RH
{
...
#endif                                 /* struct_tag_BPZvgbgNhgdvo9Q6vd49RH */

#ifndef typedef_comm_PreambleDetector
#define typedef_comm_PreambleDetector

typedef struct tag_BPZvgbgNhgdvo9Q6vd49RH comm_PreambleDetector;

#endif                                 /* typedef_comm_PreambleDetector */

#ifndef typedef_InstanceStruct_RpNfljt9ezw1bujKbI0k9E
#define typedef_InstanceStruct_RpNfljt9ezw1bujKbI0k9E

typedef struct {
  SimStruct *S;
  comm_PreambleDetector sysobj;
  boolean_T sysobj_not_empty;
  real_T y_tmp0_data[6175];
...
#endif                                 /* typedef_InstanceStruct_RpNfljt9ezw1bujKbI0k9E */
...
extern void method_dispatcher_RpNfljt9ezw1bujKbI0k9E(SimStruct *S, int_T method,
  void* data);
